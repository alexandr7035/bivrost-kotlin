...
import io.swisseth.solidity.model.AbiElementJson
...
import io.swisseth.solidity.utils.generateSolidityMethodId
    ...
    private fun generateFunctionEncoder(functionJson: AbiElementJson): FunSpec {
        ...
        finalFun.addStatement(
            "return·\"0x\"·+·METHOD_ID${if (funWithParams.parameters.isNotEmpty()) {
                "·+·io.swisseth.solidity.model.SolidityBase.encodeFunctionArguments(${funWithParams.parameters.joinToString { it.name }})"
            } else ""}"
        )
