...
import io.swisseth.solidity.utils.hexToByteArray
import io.swisseth.solidity.utils.padStartMultiple
...
object SolidityBase {
    ...
    fun decodeStaticBytes(data: String, nBytes: Int): ByteArray {
