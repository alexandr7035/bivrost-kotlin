...
import by.alexandr7035.bivkmp.solidity.utils.GeneratorUtils
import com.squareup.kotlinpoet.*
import com.squareup.kotlinpoet.ParameterizedTypeName.Companion.parameterizedBy
import kotlinx.serialization.json.Json
import by.alexandr7035.bivkmp.solidity.model.AbiElementJson
import by.alexandr7035.bivkmp.solidity.model.AbiRoot
import by.alexandr7035.bivkmp.solidity.model.ParameterJson
import by.alexandr7035.bivkmp.solidity.model.Solidity
import by.alexandr7035.bivkmp.solidity.model.SolidityBase
import by.alexandr7035.bivkmp.solidity.utils.generateSolidityMethodId
...
object AbiParser {
    ...
    internal class GeneratorContext(val root: AbiRoot, val arrays: ArraysMap, val tuples: MutableMap<String, TupleTypeHolder> = LinkedHashMap())
    ...
    private fun generateFunctionEncoder(functionJson: AbiElementJson): FunSpec {
        ...
        finalFun.addStatement(
            "return·\"0x\"·+·METHOD_ID${if (funWithParams.parameters.isNotEmpty()) {
                "·+·by.alexandr7035.bivkmp.solidity.model.SolidityBase.encodeFunctionArguments(${funWithParams.parameters.joinToString { it.name }})"
            } else ""}"
        )
